...
public class EventLocationTypeUpdate extends Page{
	...
	public EventLocationTypeUpdate(XMLFileReader params, int stepIndex) throws InvalidInputException {
	...
	protected void performAction(WebDriver driver, ActionType actionType)throws InvalidInputException, SeleniumException, VerificationException {
		if(actionType.equals(ActionType.UPDATE_LOCATION_TYPE)){
			updateNewLocationType(driver);
		}
	}
	
	private void updateNewLocationType(WebDriver driver) throws SeleniumException {
