...
public class EventLocationCreateContent extends Page{
	...
	public EventLocationCreateContent(XMLFileReader params, int stepIndex) throws InvalidInputException {
		super(params, stepIndex);
		nextPages.add(PageType.EVENT_LOCATION_CREATE_DETAILS);
	...
	protected void Goto(WebDriver driver, PageType nextPage) throws SeleniumException {
		if (PageType.EVENT_LOCATION_CREATE_DETAILS.equals(nextPage)) {
			performInteraction(driver, OperationType.CLICK, "", new By.ById("buttonNext"), null, null);
		} 
