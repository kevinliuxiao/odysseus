...
public class EventLocationCreateDetails extends Page
{
	...
	public EventLocationCreateDetails(XMLFileReader params, int stepIndex) throws InvalidInputException {
...
//	}
	...
	protected void Goto(WebDriver driver, PageType nextPage) throws SeleniumException, VerificationException, InvalidInputException {
		if (PageType.EVENT_LOCATIONS.equals(nextPage)) {
			performInteraction(driver, OperationType.CLICK,"",  new By.ById("buttonFinish"), null, null);
			if(isWaveOrLocationAction == true){
				verify(driver, "feedback", new By.ById("feedback"), "Location Created Successfully", null);
			}
		}	
	}
...
//		performInteraction(driver, OperationType.CLICK, "Submit Button", new By.ById("buttonFinish"), null, null);
...
//		performInteraction(driver, OperationType.CLICK, "Finish Button", new By.ById("buttonFinish"), null, null);
